...
<img width="192" height="208" alt="base" src="https://github.com/user-attachments/assets/5dd885c8-c159-47c1-86f1-0b06dd47ca2b" />

最后，我会贴上小冰糖所有的动作。对于我来说，我很喜欢它玩小球还有忙碌时敲键盘的样子。如果你也觉得冰糖可爱的话，可以直接下载我的这份文件，将它放在你的codex宠物文件夹下就可以使用啦！


codex宠物文件夹的地址在"C:\Users\本人用户\ .codex\pets"，将下载下来的文件夹拖动到这里（如果下载的是.zip一定要记得解压zip文档！），之后回到codex界面刷新宠物就可以获得一只可爱小猫桌宠啦！


如果没有GPT plus，也可以通过cc switch搭桥连接各种API中转进入codex，一样可以将小冰糖作为你的桌面宠物！
